...
### Step 1 - Choose plan
Go to [Web Hosting plans](https://vexyhost.com/web-hosting/). Choose the plan that best suits your needs. If you're unsure which one to choose, you can contact support for assistance.

### Step 2 - Choose your domain
When you select a plan, you'll need to indicate whether you want to use an existing domain that you have already purchased from domain provider or use a temporary subdomain from VexyHost.

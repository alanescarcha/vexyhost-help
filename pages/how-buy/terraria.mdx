...
### Step 1 - Choose plan
Go to [Terraria plans](https://billing.vexyhost.com/store/terraria). Choose the plan that best suits your needs. If you're unsure which one to choose, you can contact support for assistance.
...
### Step 4 - Dedicated IP
In the "Dedicated IP" section, you can select whether you want to have a Dedicated IP with port 7777 available only for your server.

<Callout type="info">
    The Dedicated IP is usually used to set up a domain without specifying the port in the game since the default port for Terraria is 7777.
</Callout>

### Step 5 - Version
In the "Version" section, you can select the version of your Terraria server.

<Callout type="info">
    When creating your server, the latest available version of Terraria will always be downloaded. However, in the [Game Panel](https://panel.vexyhost.com), you can choose specific versions from the Startup tab, under "TMODLOADER VERSION" if you don't want the latest version. Remember to reinstall the server after selecting a specific version.
</Callout>

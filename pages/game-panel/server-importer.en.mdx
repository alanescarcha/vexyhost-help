...
You can also choose the source folder of your old host and the destination folder of the VexyHost server, and you can choose whether you want to delete all files before starting the migration.
